...
public class SettingsDialogFragment extends SherlockDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        coefficientValue.setText(eBalanbotActivity.mSensorFusion.d.format(eBalanbotActivity.mSensorFusion.filter_coefficient));
        final SeekBar mSeekBarCoefficient = (SeekBar) view.findViewById(R.id.coefficientSeekBar);
        mSeekBarCoefficient.setProgress((int) (eBalanbotActivity.mSensorFusion.filter_coefficient * mSeekBarCoefficient.getMax()));
        mSeekBarCoefficient.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
                eBalanbotActivity.mSensorFusion.tempFilter_coefficient = ((float) progress) / mSeekBarCoefficient.getMax();
                coefficientValue.setText(eBalanbotActivity.mSensorFusion.d.format(eBalanbotActivity.mSensorFusion.tempFilter_coefficient));
            }
        ...
        maxAngle = eBalanbotActivity.maxAngle;
        ...
        maxTurning = eBalanbotActivity.maxTurning;
        ...
        backToSpot = eBalanbotActivity.backToSpot;
            ...
            public void onClick(View v) {
                if (eBalanbotActivity.mChatService != null) {
                    if (eBalanbotActivity.mChatService.getState() == BluetoothChatService.STATE_CONNECTED) {
                        eBalanbotActivity.mChatService.write(eBalanbotActivity.restoreDefaultValues);
        ...
        mPairButtonWii.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (eBalanbotActivity.mChatService != null) {
                    if (eBalanbotActivity.mChatService.getState() == BluetoothChatService.STATE_CONNECTED) {
                        eBalanbotActivity.mChatService.write(eBalanbotActivity.sendPairWithWii);
                        dismiss();
                    }
                }
            }
        ...
        mPairButtonPS4.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (eBalanbotActivity.mChatService != null) {
                    if (eBalanbotActivity.mChatService.getState() == BluetoothChatService.STATE_CONNECTED) {
                        eBalanbotActivity.mChatService.write(eBalanbotActivity.sendPairWithPS4);
                        dismiss();
                    }
                }
            }
        ...
        builder.setTitle(R.string.dialog_title)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        eBalanbotActivity.mSensorFusion.filter_coefficient = eBalanbotActivity.mSensorFusion.tempFilter_coefficient;
                        eBalanbotActivity.maxAngle = maxAngle;
                        eBalanbotActivity.maxTurning = maxTurning;
                        eBalanbotActivity.backToSpot = backToSpot;
                        if (eBalanbotActivity.mChatService != null) {
                            if (eBalanbotActivity.mChatService.getState() == BluetoothChatService.STATE_CONNECTED) {
                                int val = backToSpot ? 1 : 0;
                                eBalanbotActivity.mChatService.write(eBalanbotActivity.setMaxAngle + maxAngle + ";" + eBalanbotActivity.setMaxTurning + maxTurning + ";" + eBalanbotActivity.setBackToSpot + val + ";" + eBalanbotActivity.getSettings);
                            }
                        }
                    }
                })
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        eBalanbotActivity.mSensorFusion.tempFilter_coefficient = eBalanbotActivity.mSensorFusion.filter_coefficient;
                    }
                })
                        // Set custom view
                .setView(view);
