...
import com.edutech.eBalanbot.BuildConfig;
import com.edutech.eBalanbot.R;
import com.viewpagerindicator.UnderlinePageIndicator;

public class eBalanbotActivity extends SherlockFragmentActivity implements ActionBar.TabListener {
    private static final String TAG = "YiBalanbot";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.educationtek.com"));
    ...
    static class BluetoothHandler extends Handler {
        private final eBalanbotActivity mEBalanbotActivity;
        private String mConnectedDeviceName; // Name of the connected device

        BluetoothHandler(eBalanbotActivity mEBalanbotActivity) {
            this.mEBalanbotActivity = mEBalanbotActivity;
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_STATE_CHANGE:
                    mEBalanbotActivity.supportInvalidateOptionsMenu();
                    if (D)
                        Log.i(TAG, "MESSAGE_STATE_CHANGE: " + msg.arg1);
                    switch (msg.arg1) {
                        case BluetoothChatService.STATE_CONNECTED:
                            eBalanbotActivity.showToast(mEBalanbotActivity.getString(R.string.connected_to) + " " + mConnectedDeviceName, Toast.LENGTH_SHORT);
                            if (mChatService == null)
                                return;
                ...
                case MESSAGE_READ:
                    ...
                    if (pairingWithDevice) {
                        ...
                        eBalanbotActivity.showToast("Now enable discovery of your device", Toast.LENGTH_LONG);
                    }
                    break;
                ...
                case MESSAGE_DISCONNECTED:
                    ...
                    PIDFragment.updateButton();
                    if (msg.getData() != null)
                        eBalanbotActivity.showToast(msg.getData().getString(TOAST), Toast.LENGTH_SHORT);
                    break;
                case MESSAGE_RETRY:
                    if (D)
                        Log.d(TAG, "MESSAGE_RETRY");
                    mEBalanbotActivity.connectDevice(null, true);
                    break;
            }
        }
    }
