...
ADK adk(&Usb, "Edutech Emaker", // Manufacturer Name
              "eBalanbot", // Model Name
              "Android App for eBalanbot", // Description - user visible string
              "0.6.3", // Version of the Android app
              "https://play.google.com/store/apps/details?id=com.edutech.ebalanbot", // URL - web page to visit if no installed apps support the accessory
...
#ifdef ENABLE_SPP
SPP SerialBT(&Btd, "eBalanbot", "0000"); // The SPP (Serial Port Protocol) emulates a virtual Serial port, which is supported by most computers and mobile phones
#endif
